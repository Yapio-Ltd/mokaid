...
KEYS="secret_key_base worker_auth_token openai_api_key anthropic_api_key deepseek_api_key stripe_secret_key stripe_publishable_key stripe_webhook_secret figma_client_id figma_client_secret google_client_id google_client_secret github_client_id github_client_secret linear_client_id linear_client_secret slack_client_id slack_client_secret slack_signing_secret slack_app_id slack_verification_token notion_client_id notion_client_secret"
