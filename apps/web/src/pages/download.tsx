...
export const desktopReleaseSchema = z.object({
  ...
  for (const [platform, extension] of [["macos-arm64", "dmg"], ["windows-x64", "exe"]] as const) {
  ...
  if (release.releaseNotesUrl !== `https://github.com/Yapio-Ltd/mokaid/releases/tag/desktop-v${release.version}`) {
...
const platforms = [
  { id: "macos-arm64", name: "macOS", subtitle: "Apple Silicon · macOS 13 or later", extension: "DMG" },
  { id: "windows-x64", name: "Windows", subtitle: "64-bit Intel / AMD · Windows 11", extension: "EXE" },
] as const;

export function DownloadPage() {
  useSeo({
    title: "Download Mokaid Desktop",
    description: "Your AI workspace, agents and 3D office in the Mokaid desktop application for macOS and Windows.",
    path: "/download",
  });
