...
export function NewAgentForm() {
  ...
  return (
    <div className="mx-auto w-full max-w-6xl space-y-6">
      ...
      <div className="grid gap-8 rounded-2xl border border-border bg-surface/60 p-5 md:grid-cols-[1fr_minmax(280px,340px)] md:gap-10 md:p-8">
        <div className="space-y-6">
          ...
          <Field label="Head start (optional)" hint={`Balance: ${formatNumber(spendable)} credits`}>
            <div className="space-y-2">
              <button
                type="button"
