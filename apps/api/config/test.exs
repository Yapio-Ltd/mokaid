...
# Avoid bulk mcp_servers / assets_3d seed inside list_*/0 — concurrent Sandbox
# tests deadlock when multiple suites re-insert catalog rows at once.
config :mokaid, :auto_seed_mcp_catalog, false
config :mokaid, :auto_seed_assets_3d, false
